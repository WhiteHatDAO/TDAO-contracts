...
export const AuthorForm = ( { register, control, handleSubmit, reset, formState, watch } ) => {
    ...
    return (
        <>
            <h5 className="text-left justify-left">If you want to remain anonymous, you may leave one or both name fields blank. You may also use a pseudonym.</h5>
            <div className="border-bottom">
                <div className="form-row">
                    <div className="form-group text-left">
                        <label className="block text-left text-sm font-medium text-gray-700">Number of Authors</label>
                        <select name="numberOfAuthors" {...register('numberOfAuthors')}
                            className={`form-control mt-1 block w-1/4 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md ${errors.numberOfAuthors ? 'is-invalid' : ''}`}>
                    ...
                    <div className="list-group-item">
                        ...
                        <div className="form-row">
                            <div className="form-group col-6">
                                ...
                                <input name={`tickets[${i}]name`} {...register(`tickets.${i}.name`)} type="text" className={`form-control mt-1 block w-1/4 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md ${errors.tickets?.[i]?.name ? 'is-invalid' : ''}`} />
                            ...
                            <div className="form-group col-6">
                                ...
                                <input name={`tickets[${i}]email`} {...register(`tickets.${i}.email`)} type="text" className={`form-control mt-1 block w-1/4 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md ${errors.tickets?.[i]?.email ? 'is-invalid' : ''}`} />
