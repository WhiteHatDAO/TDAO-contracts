    ...
    <div className="mx-4 relative flex flex-col lg:flex-row place-content-between items-center rounded-3xl" style={{ background: 'linear-gradient(100.23deg, #0037B5 3.84%, #B41C2E 108.44%)' }}>
      ...
      <div className="z-1 flex flex-col text-left mt-4 lg:mt-32 mb-20 ml-0 lg:ml-16">
        ...
        <div className="pt-10 lg:pt-16 flex flex-col lg:flex-row lg:items-center">
          ...
          <div className="w-72 my-4 lg:my-0 mx-0 lg:mx-4 py-3 flex flex-row items-center justify-between bg-primary hover:bg-opacity-80 rounded-lg text-white cursor-pointer" onClick={() => history.push(`/submit/${address}`)}>
