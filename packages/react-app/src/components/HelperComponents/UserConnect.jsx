            ...
            <div className="rounded-2xl p-8 bg-white flex flex-col text-left space-y-4">
                {
                    !toTypeWallet ? (
                        <>
                            ...
                            <div className="rounded-xl text-lg bg-primary text-white text-center cursor-pointer py-2" onClick={() => setToTypeWallet(true)}>
                                Connect Wallet
                            </div>
                        </>
                    ) : (
                        <>
                            <div className="rounded-xl bg-primary text-white text-center cursor-pointer py-4 flex flex-row items-center justify-center" onClick={() => setToTypeWallet(true)}>
