  ...
  const Menu = () => (
    <>
      <div className="pl-8 pr-2 py-2 lg:hidden flex flex-row items-center justify-between text-lg text-primary">
        <div>Connect</div>
        <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={handleMenuOpen}>
          <path d="M14.4785 6.9L11.5 9.8785L8.5215 6.9L6.9 8.5215L9.8785 11.5L6.9 14.4785L8.5215 16.1L11.5 13.1215L14.4785 16.1L16.1 14.4785L13.1215 11.5L16.1 8.5215L14.4785 6.9ZM11.5 0C5.1405 0 0 5.1405 0 11.5C0 17.8595 5.1405 23 11.5 23C17.8595 23 23 17.8595 23 11.5C23 5.1405 17.8595 0 11.5 0ZM11.5 20.7C6.4285 20.7 2.3 16.5715 2.3 11.5C2.3 6.4285 6.4285 2.3 11.5 2.3C16.5715 2.3 20.7 6.4285 20.7 11.5C20.7 16.5715 16.5715 20.7 11.5 20.7Z" fill="#656565" />
        </svg>
      </div>
